                        ...
                        <section id="logo" class="col-xs-12 col-sm-12 col-md-5">
                            <div class="region region-head-logo">
                                <section id="block-block-4" class="block block-block clearfix">
                                    ...
                                    <div class="col-xs-3 col-sm-3 col-md-3 main-logos"><a href="http://educacionensalud.imss.gob.mx/"><img alt="Coordinación de Educación en Salud" class="img-responsive" src="<?php echo asset_url(); ?>img/ces.png"></a></div>
